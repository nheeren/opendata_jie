> This template is meant for use by Data Editors (DE) for providing feedback to Associate Editors (AE) and authors that requested a data transparency badge. Some notes:
